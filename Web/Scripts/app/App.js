...
var App = function () {
    ...
    return {
        ...
        handleDatepickerReadonly: function () {
            $("input[data-role='datepicker']").attr("readonly", true);
        },

        handleMenu: function () {
            console.log("((handleMenu))");
            $("li.active").closest("ul").addClass("in").closest("li").addClass("active").closest("ul").addClass("in").closest("li").addClass("active");
        }
    };
}();
